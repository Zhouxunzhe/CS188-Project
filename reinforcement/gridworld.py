...
if __name__ == '__main__':
    ...
    if opts.agent == 'value':
        ...
        a = valueIterationAgents.AsynchronousValueIterationAgent(mdp, opts.gamma, opts.iters)
    elif opts.agent == 'priosweepvalue':
        a = valueIterationAgents.PrioritizedSweepingValueIterationAgent(mdp, opts.gamma, opts.iters)
    else:
